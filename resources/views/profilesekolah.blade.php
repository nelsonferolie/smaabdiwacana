...
@section('konten')
    ...
    <div style="background-image: url(assets/img/bg-title.jpg)">
        <div style="padding:110px;">
            <h1 class="text-light fw-semibold"><strong>Visi dan Misi</strong></h1>
        </div>
    </div>
