                                    ...
                                    <tbody>
                                        @foreach ($guru as $result => $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->nama }}</td>
                                                <td>{{ $data->nip }}</td>
                                                <td>{{ $data->mapel->nama_mapel }} |
                                                    {{ $data->mapel->jurusan->nama_jurusan }}</td>
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('guru.destroy', $data->id) }}">
                                                            @csrf
                                                            @method('delete')
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nama" name="nama"
                                                    ...
                                                    placeholder="{{ __('Nama Guru') }}" value="{{ old('nama') }}">
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="nip" name="nip"
                                                        ...
                                                        placeholder="{{ __('NIP Guru') }}" value="{{ old('nip') }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="no_telp">No. Telp</label>
                                                    <input type="number" id="no_telp" name="no_telp"
                                                        class="form-control @error('no_telp') is-invalid @enderror"
                                                        placeholder="{{ __('No. Telp Guru') }}"
                                                        value="{{ old('no_telp') }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="alamat" name="alamat" class="form-control @error('alamat') is-invalid @enderror"
                                                    placeholder="{{ __('Alamat') }}" value="{{ old('alamat') }}"></textarea>
                                            </div>
                                            <div class="form-group">
