    ...
    <script>
        $(document).ready(function() {
            $('#roles').change(function() {
                ...
                if (kel == "guru") {
                    $("#noId").html(
                        '<label for="nip">NIP guru</label><input id="nip" type="text" onkeypress="return inputAngka(event)" placeholder="NIP Guru" class="form-control" name="nip" autocomplete="off">'
                    );
                } else if (kel == "siswa") {
                    $("#noId").html(
                        `<label for="nis">NIS Siswa</label><input id="nis" type="text" placeholder="NIS Siswa" class="form-control" name="nis" autocomplete="off">`
                    );
                } else if (kel == "admin") {
                    $("#noId").html(
                        `<label for="name">Nama Admin</label><input id="name" type="text" placeholder="Nama admin" class="form-control" name="name" autocomplete="off">`
                    );
                } else {
                    $("#noId").html("")
                }
